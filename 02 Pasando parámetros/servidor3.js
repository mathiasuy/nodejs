...
function iniciar(enrutar){// recibo la funcion que esta en enrutador.js que me pasaron en inicio.js 
	function arrancaServidor(requiere, respuesta){
		...
		enrutar(ruta);	//le paso a la funcion el path de la url donde estoy parado
